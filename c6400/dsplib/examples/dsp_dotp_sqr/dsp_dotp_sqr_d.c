...
/*                                                                          */
/*  NAME                                                                    */
/*      DSP_dotp_sqr_d.c -- Example file for DSP_dotp_sqr                   */
/*                                                                          */
/*  USAGE                                                                   */
/*      This file contains code for demonstrating the C64x DSPLIB           */
/*      DSP_dotp_sqr function. All inputs to the function contain random    */
/*      data. The assembly version of DSP_dotp_sqr is called and the        */
...
int DSP_dotp_sqr_c(int g, const short * x, const short * y, int * r, int nx);
...
/* ======================================================================== */   
    ret_val_asm = DSP_dotp_sqr(g, x, y, &r_asm, NX);
